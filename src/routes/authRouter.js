...
const { incrementActiveUsers, decrementActiveUsers, trackAuthenticationAttempts } = require('../../metrics.js');
...
authRouter.authenticateToken = (req, res, next) => {
  if (!req.user) {
    trackAuthenticationAttempts('failure');
    return res.status(401).send({ message: 'unauthorized' });
  }
  trackAuthenticationAttempts('success');
  next();
};
